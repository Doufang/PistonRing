...
namespace Basler_UsbCameraParams
{
	...
	//! \name SequencerControl - This category includes sequencer controls
    //@{
	/*!	
		\brief 
...
#   pragma warning(pop)
    ...
    //@{
	/*!	
		\brief This feature has been \b deprecated. 
...
#   pragma warning(pop)
    ...
    */
    ...
    //@{
	/*!	
		\brief Resets the overload status of the selected line.
    ...
    */
    ...
    //@{
	/*!	
		\brief Return the index of the active set of the running sequencer included in the payload.
...
#   pragma warning(pop)
	...
	static_cast<GenApi::CEnumerationTRef<LineFormatEnums> *> (&LineFormat )->SetEnumReference( LineFormat_NoConnect, "NoConnect" );		static_cast<GenApi::CEnumerationTRef<LineFormatEnums> *> (&LineFormat )->SetEnumReference( LineFormat_TriState, "TriState" );		static_cast<GenApi::CEnumerationTRef<LineFormatEnums> *> (&LineFormat )->SetEnumReference( LineFormat_TTL, "TTL" );		static_cast<GenApi::CEnumerationTRef<LineFormatEnums> *> (&LineFormat )->SetEnumReference( LineFormat_LVDS, "LVDS" );		static_cast<GenApi::CEnumerationTRef<LineFormatEnums> *> (&LineFormat )->SetEnumReference( LineFormat_RS422, "RS422" );		static_cast<GenApi::CEnumerationTRef<LineFormatEnums> *> (&LineFormat )->SetEnumReference( LineFormat_OptoCoupled, "OptoCoupled" );		static_cast<GenApi::CEnumerationTRef<LineLogicEnums> *> (&LineLogic )->SetReference(_Ptr->GetNode("LineLogic"));
    ...
    static_cast<GenApi::CEnumerationTRef<UserSetSelectorEnums> *> (&UserSetSelector )->SetNumEnums(7);
    ...
    static_cast<GenApi::CEnumerationTRef<UserSetDefaultEnums> *> (&UserSetDefault )->SetNumEnums(7);
